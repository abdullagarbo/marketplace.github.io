...
jQuery(document).ready(function (e) {
	e("#report_abuse").click(function (t) {
		t.preventDefault(), e("#report_abuse_form").simplePopup()
	}), e(".submit-report-abuse").on("click", function (t) {
		var a = document.getElementById("report_abuse_name");
		!1 === a.checkValidity() ? e("#report_abuse_name").next("span").html(a.validationMessage) : e("#report_abuse_name").next("span").html("");
		var r = document.getElementById("report_abuse_email");
		!1 === r.checkValidity() ? e("#report_abuse_email").next("span").html(r.validationMessage) : e("#report_abuse_email").next("span").html("");
		var o = document.getElementById("report_abuse_msg");
		!1 === o.checkValidity() ? e("#report_abuse_msg").next("span").html(o.validationMessage) : e("#report_abuse_msg").next("span").html(""), t.preventDefault();
		var n = {
			action: "send_report_abuse",
			product_id: e(".report_abuse_product_id").val(),
			name: e(".report_abuse_name").val(),
			email: e(".report_abuse_email").val(),
			msg: e(".report_abuse_msg").val()
		};
		a.checkValidity() && r.checkValidity() && o.checkValidity() && e.post(frontend_js_script_data.ajax_url, n, function (t) {
			e(".simplePopupClose").click(), e("#report_abuse").css({
				"box-shadow": "none",
				cursor: "default",
				color: "#686868"
			}), e("#report_abuse").attr("href", "javascript:void(0)"), e("#report_abuse").off("click"), e("#report_abuse").text(front_end_param.report_abuse_msg)
		})
	}), e("#wcmp_widget_vendor_search .search_keyword").on("input", function () {
		var t = {
			action: "vendor_list_by_search_keyword",
			s: e(this).val(),
			vendor_search_nonce: e("#wcmp_vendor_search_nonce").val()
		};
		e.post(frontend_js_script_data.ajax_url, t, function (t) {
			e("#wcmp_widget_vendor_list").html(""), e("#wcmp_widget_vendor_list").html(t)
		})
	}), e("#vendor_sort_type").change(function () {
		"category" == e(this).val() ? e("#vendor_sort_category").show() : e("#vendor_sort_category").hide()
	}).change(), e(".wcmp_fpm_delete").each(function () {
		e(this).click(function (t) {
			return t.preventDefault(), confirm(frontend_js_script_data.messages.confirm_dlt_pro) && function (t) {
				e(".woocommerce").block({
					message: null,
					overlayCSS: {
						background: "#fff",
				...
				e.ajax({
					...
					data: a,
					success: function (t) {
						t ? ($response_json = e.parseJSON(t), "success" == $response_json.status ? window.location = $response_json.shop_url : e(".woocommerce").unblock()) : e(".woocommerce").unblock()
					}
				})
			}(e(this)), !1
		})
...
! function (p) {
	p.fn.simplePopup = function (o) {
		var i = p.extend({}, o),
			n = p(this),
			e = (p.extend(i, o), {
				init: function () {
					return this.each(function () {
						e.appendHTML(), e.setEventHandlers(), e.showPopup()
					})
				},
				appendHTML: function () {
					if (0 === p(".simplePopupBackground").length) {
						p("body").prepend('<div class="simplePopupBackground"></div>')
					}
					if (0 === n.find(".simplePopupClose").length) {
						n.prepend('<div class="simplePopupClose">X</div>')
					}
				},
				setEventHandlers: function () {
					p(".simplePopupClose, .simplePopupBackground").on("click", function (p) {
						e.hidePopup()
				...
				showPopup: function () {
					p(".simplePopupBackground").css({
						opacity: "0.7"
					}), p(".simplePopupBackground").fadeIn("fast"), n.fadeIn("slow"), e.positionPopup()
				},
				hidePopup: function () {
					p(".simplePopupBackground").fadeOut("fast"), n.fadeOut("fast")
				},
				positionPopup: function () {
					p(window).width();
					var o = p(window).height(),
						i = (n.width(), o / 2 - n.height() / 2);
					i < 30 && (i = 30)
				}
			});
		return e[o] ? e[o].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof o && o ? void p.error('Method "' + method + '" does not exist in simple popup plugin!') : e.init.apply(this)
	}
}(jQuery);
jQuery(document).ready(function (t) {
	var o;
	o = "undefined" != typeof themeSingleProductMultivendor ? themeSingleProductMultivendor : "#tab-singleproductmultivendor";
	var e = t(o + " .rowbody").length;
	if (parseInt(e) > 4) {
		var n = 0;
		t(o + " .rowbody").each(function () {
			parseInt(n) >= 4 && t(this).hide(), n = parseInt(n) + 1
		});
		t.post(wcmp_single_product_multiple_vendors_script_data.ajax_url, {
			action: "get_loadmorebutton_single_product_multiple_vendors"
		}, function (e) {
			t(o).append(e)
		})
	}
	t("body").on("click", "button#wcmp-load-more-button", function (e) {
		t(o + " .rowbody").each(function () {
			t(this).show("slow")
		}), t(this).hide("slow")
	}), t("#wcmp_multiple_product_sorting").change(function (e) {
		t(o + " .ajax_loader_class_msg").show();
		var n = t(this).val(),
			r = t(this).attr("attrid");
		if ("" != n) {
			var a = {
			...
			t.post(wcmp_single_product_multiple_vendors_script_data.ajax_url, a, function (e) {
				t(o + " .rowbody").each(function () {
					t(this).remove()
				}), t(e).insertAfter(o + " .rowhead");
				var n = 0,
					r = t(o + " .rowbody").length;
				parseInt(r) > 4 && "none" != t(o + " #wcmp-load-more-button").css("display") && t(o + " .rowbody").each(function () {
					parseInt(n) >= 4 && t(this).hide(), n = parseInt(n) + 1
				}), t(o + " .ajax_loader_class_msg").hide()
			})
		}
	}), t(".goto_more_offer_tab").click(function (o) {
		o.preventDefault(), t(".singleproductmultivendor_tab").hasClass("active") || t(".singleproductmultivendor_tab a, #tab_singleproductmultivendor").click(), t(".woocommerce-tabs").length > 0 && t("html, body").animate({
...
! function (a) {
	var t, n = function (a) {
			r(a) || a.addClass("processing").block({
				message: null,
				overlayCSS: {
					background: "#fff",
					opacity: .6
	...
	a("#cust_question").on("keyup", function () {
		var r = a(this).val();
		clearTimeout(t), t = setTimeout(function () {
			if (a("#qna-result-msg").html(""), n(a("#cust_qna_form")), r.length > 3) {
				var t = {
					action: "wcmp_customer_ask_qna_handler",
					handler: "search",
					product_ID: a("#product_ID").val(),
					keyword: r
				};
				a.post(wcmp_customer_qna_js_script_data.ajax_url, t, function (t) {
					e(a("#cust_qna_form")), 1 == t.no_data ? (a("#qna-result-msg").html(t.message), a("#qna-result-wrap").html(""), 0 == t.is_user && (a("#ask-wrap #ask-qna").hide(), a("#ask-wrap .no-answer-lbl").html(t.message)), a("#ask-wrap").show()) : a("#qna-result-wrap").html(t.data)
				})
			} else {
				a("#ask-wrap").hide();
				t = {
				...
				a.post(wcmp_customer_qna_js_script_data.ajax_url, t, function (t) {
					e(a("#cust_qna_form")), 1 == t.no_data ? (a("#qna-result-msg").html(t.message), a("#qna-result-wrap").html(""), a("#ask-wrap").show()) : (a("#qna-result-wrap").html(t.data), a("#qna-result-wrap .qna-item-wrap").not(".load-more-qna").hide(), a("#qna-result-wrap .qna-item-wrap").slice(0, 4).show())
				})
			}
		}, 500)
	}), a("body").on("click", "#ask-qna", function () {
		a("#qna-result-msg").html(""), n(a("#cust_qna_form"));
		var t = {
			action: "wcmp_customer_ask_qna_handler",
			handler: "submit",
			customer_qna_data: a("#customerqnaform").serialize()
		};
		a.post(wcmp_customer_qna_js_script_data.ajax_url, t, function (a) {
			0 == a.no_data && (window.location = a.redirect)
		})
	}), a("body").on("click", "button.wcmp-add-qna-reply", function () {
		var t = a(this).attr("data-key"),
			n = a("#qna-reply-" + t).val();
		if ("" === n) return !1;
		var r = {
			action: "wcmp_customer_ask_qna_handler",
		...
		a.post(wcmp_customer_qna_js_script_data.ajax_url, r, function (a) {
			0 == a.no_data && window.location.reload()
		})
	}), a("body").on("click", "button.wcmp-update-qna-answer", function () {
		var t = a(this).attr("data-key"),
			n = a("#qna-answer-" + t).val();
		if ("" === n) return !1;
		var r = {
			action: "wcmp_customer_ask_qna_handler",
	...
	}), a("body").on("click", ".qna-vote .give-vote-btn", function (t) {
		t.preventDefault(), n(a("#cust_qna_form"));
		var r = a(this).attr("data-vote"),
			o = a(this).attr("data-ans");
		if ("" === r) return !1;
		var s = {
			action: "wcmp_customer_ask_qna_handler",
			handler: "vote_answer",
		...
		a.post(wcmp_customer_qna_js_script_data.ajax_url, s, function (t) {
			e(a("#cust_qna_form")), 0 == t.no_data && setTimeout(function () {
				window.location = t.redirect
			}, 1e3)
		})
	}), a("body").on("click", ".non_loggedin", function (t) {
		t.preventDefault(), a("#qna_user_msg_wrap").simplePopup()
	}), a(document).ready(function () {
		a("#qna-result-wrap .qna-item-wrap").not(".load-more-qna").hide(), a("#qna-result-wrap .qna-item-wrap").slice(0, 4).show()
	}), a("body").on("click", ".load-more-qna .load-more-btn", function (t) {
		t.preventDefault(), a("#qna-result-wrap .qna-item-wrap:hidden").slice(0, 4).slideDown(), 0 == a("#qna-result-wrap .qna-item-wrap:hidden").length && (a("#qna-result-wrap .load-more-qna").fadeOut("slow"), a("#qna-result-wrap .qna-item-wrap").not(".load-more-qna").last().css("border-bottom", "1px solid #e2e2e2")), a("html,body").animate({
