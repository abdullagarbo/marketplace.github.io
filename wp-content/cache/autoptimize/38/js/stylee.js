	...
	c.init = function () {
		...
		if (!(t.length <= 0)) {
			...
			var e = t.data("autoplay"),
				o = !1,
				i = 1e3;
			0 < e ? (i = e, e = o = !0) : e = !1, t.not(".slick-initialized").slick({
				rtl: "true" === martfuryData.direction,
				slidesToShow: 1,
				slidesToScroll: 1,
				autoplaySpeed: i,
		...
		t.length <= 0 || t.each(function () {
			var t = p(this).data("columns"),
				...
				o = !1,
				i = 1e3;
			0 < e ? (i = e, e = o = !0) : e = !1, p(this).find("ul.products").not(".slick-initialized").slick({
				rtl: "true" === martfuryData.direction,
				slidesToShow: t,
				slidesToScroll: t,
				autoplaySpeed: i,
		...
		var t = c.$body.find(".mf-product-instagram ul.products"),
			...
			i = !1,
			a = 1e3;
		t.length < 1 || (0 < o ? (a = o, o = i = !0) : o = !1, t.not(".slick-initialized").slick({
			rtl: "true" === martfuryData.direction,
			slidesToShow: e,
			slidesToScroll: e,
			autoplaySpeed: a,
